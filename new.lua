...
getgenv().gagConfig = {
    ...
    PLANT_EGGS = { "Sprout Egg" ,"Rare Egg", "Gourmet Egg", "Zen Egg", "Anti Bee Egg", "Primal Egg", "Bug Egg", "Paradise Egg", "Mythical Egg", "Legendary", "Common Summer Egg", "Rare Summer Egg", "Common" },
